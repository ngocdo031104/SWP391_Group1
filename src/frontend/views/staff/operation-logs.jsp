<%-- Màn hình 44: Review Tour Operation Logs - Xem nhật ký vận hành tour (Staff) Tác giả: Dương Quang Sơn MSSV: HE186525
    Ngày tạo: 2026-07-21 --%>
                                ...
                                <div class="content-area">
                                    ...
                                    <div class="page-header">
                                        <div>
                                            ...
                                            <p>Xem to&#224;n b&#7897; nh&#7853;t k&#253; ho&#7841;t &#273;&#7897;ng
                                                c&#7911;a h&#7879; th&#7889;ng tour</p>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Stats -->
                                    <div
                                        style="display:grid;grid-template-columns:repeat(2,1fr);gap:20px;margin-bottom:24px;max-width:400px;">
                                        <div class="stat-card">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h3><i data-lucide="clock-rotate-left" style="color:var(--primary);"></i>
                                                Nh&#7853;t K&#253; Ho&#7841;t &#272;&#7897;ng</h3>
                                        </div>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="log" items="${logs}">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div style="font-weight:500;">${log.tourName}
                                                                        </div>
                                                                        <c:if test="${not empty log.departureDate}">
                                                                            <div
                                                                                style="font-size:12px;color:var(--gray-500);">
                                                                                <fmt:formatDate
                                                                                    value="${log.departureDate}"
                                                                                    pattern="dd/MM/yyyy" />
                                                                            </div>
                                                                        </c:if>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${not empty log.operatorName}">
                                                                                ${log.operatorName}
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <span
                                                                                    style="color:var(--gray-500);font-style:italic;">H&#7879;
                                                                                    th&#7889;ng</span>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </td>
                                                                    <td>
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${log.operatorRole eq 'Admin'}">
                                                                                <span
                                                                                    class="badge badge-primary">Admin</span>
                                                                            </c:when>
                                                                            <c:when
                                                                                test="${log.operatorRole eq 'Staff'}">
                                                                                <span
                                                                                    class="badge badge-warning">Staff</span>
                                                                            </c:when>
                                                                            <c:when
                                                                                test="${log.operatorRole eq 'Guide'}">
                                                                                <span
                                                                                    class="badge badge-success">Guide</span>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <span
                                                                                    class="badge badge-secondary">${log.operatorRole}</span>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </td>
                                                                </tr>
