                    ...
                    <%@ include file="/admin/staff-sidebar.jsp" %>
                        ...
                        <main class="main-content">
                            <div class="content-area">
                                ...
                                <!-- Stats -->
                                <div
                                    style="display:grid;grid-template-columns:repeat(4,1fr);gap:20px;margin-bottom:24px;">
                                                ...
                                                <table class="table-modern">
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="incident" items="${incidents}">
                                                            <tr>
                                                                <td>
                                                                    <div style="font-weight:600;">${incident.tourName}
                                                                    </div>
                                                                    <div style="font-size:12px;color:var(--gray-500);">
                                                                        <fmt:formatDate
                                                                            value="${incident.departureDate}"
                                                                            pattern="dd/MM/yyyy" />
                                                                ...
                                                                <td>
                                                                    <div style="font-weight:500;">${incident.title}
                                                                    </div>
                                                                    <div
                                                                        style="font-size:12px;color:var(--gray-500);max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                                                ...
                                                                <td>
                                                                    <span
                                                                        class="badge severity-${incident.severity}">${incident.severity}</span>
                                                                </td>
                                                                <td>
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <span
                                                                                class="badge badge-secondary">${incident.status}</span>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </td>
                                                                <td>
                                                                    <fmt:formatDate value="${incident.createdAt}"
