                    ...
                    <main class="main-content">
                        <div class="content-area" style="padding: 28px 36px;">
                            <div class="page-header"
                                style="margin-bottom: 28px; display: flex; align-items: center; justify-content: space-between;">
                                <div>
                                    <h1 style="margin:0;font-size:24px;font-weight:700;color:var(--gray-900);">G&#7917;i
                                        Th&#244;ng B&#225;o</h1>
                                    <p style="margin:4px 0 0;color:var(--gray-500);font-size:14px;">G&#7917;i th&#244;ng
                                        b&#225;o in-app ho&#7863;c email &#273;&#7871;n kh&#225;ch h&#224;ng</p>
                                </div>
                                <a href="${pageContext.request.contextPath}/staff/bookings" class="btn-secondary">
                                    <i data-lucide="arrow-left" style="width:15px;height:15px;"></i> Quay l&#7841;i
                                    Booking
                                </a>
                            </div>

                            <c:if test="${not empty error}">
                                <div class="alert alert-danger"><i data-lucide="x-circle"
                                        style="width:16px;height:16px;flex-shrink:0;"></i> ${error}</div>
                            </c:if>
                            <c:if test="${not empty success}">
                                <div class="alert alert-success"><i data-lucide="check-circle"
                                        style="width:16px;height:16px;flex-shrink:0;"></i> ${success}</div>
                            </c:if>
                            <c:if test="${not empty warning}">
                                <div class="alert alert-warning"><i data-lucide="alert-triangle"
                                        style="width:16px;height:16px;flex-shrink:0;"></i> ${warning}</div>
                            </c:if>
                            ...
                            <div class="form-card">
                                <form action="${pageContext.request.contextPath}/staff/send-notification" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="userIds" id="userIds" multiple required class="form-control">
                                            <c:forEach var="customer" items="${customers}">
                                                <option value="${customer.userId}">${customer.fullName}
                                                    (${customer.email})</option>
                                            </c:forEach>
                                        </select>
                                        <p class="form-hint">Gi&#7919; <kbd>Ctrl</kbd> (ho&#7863;c <kbd>&#8984;</kbd>
                                            tr&#234;n Mac) &#273;&#7875; ch&#7885;n nhi&#7873;u kh&#225;ch h&#224;ng.
                                        </p>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <select name="category" id="category" required class="form-control">
                                                ...
                                                <option value="Account Activity">Ho&#7841;t &#273;&#7897;ng t&#224;i
                                                    kho&#7843;n</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="scheduledAt">L&#234;n L&#7883;ch G&#7917;i <span
                                                style="font-weight:400;color:var(--gray-500);">(&#273;&#7875;
                                                tr&#7889;ng n&#7871;u mu&#7889;n g&#7917;i ngay)</span></label>
                                    ...
                                    <div style="display:flex;gap:12px;margin-top:8px;">
                                        <button type="submit" class="btn-submit">
                                            <i data-lucide="send" style="width:16px;height:16px;"></i> G&#7917;i
                                            Th&#244;ng B&#225;o
                                        </button>
                                    </div>
                                </form>
