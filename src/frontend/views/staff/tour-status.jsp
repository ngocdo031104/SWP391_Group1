                                                                        ...
                                                                        <c:forEach var="log" items="${logs}">
                                                                            <div class="timeline-item">
                                                                                <div
                                                                                    ...
                                                                                    ${log.activity}</div>
                                                                                <div
                                                                                    style="font-size:13px;color:var(--gray-500);">
                                                                                    <fmt:formatDate
                                                                                        value="${log.createdAt}"
                                                                            ...
                                                                            <c:forEach var="schedule"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <c:choose>
                                                                                            <c:when
                                                                                                test="${not empty schedule.guide}">
                                                                                                <div
                                                                                                    style="display:flex;align-items:center;gap:8px;">
                                                                                                    <div
                                                                                                        style="width:32px;height:32px;border-radius:50%;background:var(--primary-light);color:var(--primary);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:12px;">
                                                                                                        ${fn:substring(schedule.guide.fullName,
                                                                                                        0, 1)}
                                                                                                    </div>
                                                                                                    <span
                                                                                                        style="font-weight:500;">${schedule.guide.fullName}</span>
                                                                                                </div>
                                                                                            </c:when>
                                                                                            <c:otherwise>
                                                                                                <span
                                                                                    ...
                                                                                    <td style="text-align:center;">
                                                                                        <button
                                                                                            ...
                                                                                            onclick="openLogsModal(${schedule.scheduleId}, '${schedule.tour.tourName}')">
                                                                                            <i data-lucide="clock-rotate-left"
