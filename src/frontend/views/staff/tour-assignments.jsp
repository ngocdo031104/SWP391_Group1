<%-- Màn hình 28: Assign Tour Guide - Phân công hướng dẫn viên cho lịch khởi hành (Staff) Tác giả: Dương Quang Sơn MSSV:
    HE186525 Ngày tạo: 2026-07-21 --%>
                                                            ...
                                                            <table class="table-modern">
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="schedule"
                                                                        items="${unassignedSchedules}">
                                                                        <tr>
                                                                            <td>
                                                                                <div
                                                                                    style="font-weight:600;color:var(--gray-900);">
                                                                                    ${schedule.tour.tourName}</div>
                                                                                <div
                                                                                    style="font-size:12px;color:var(--gray-500);">
                                                                                    ${schedule.tour.destination}</div>
                                                                            </td>
                                                                            <td>
                                                                                <fmt:formatDate
                                                                            ...
                                                                            <td>
                                                                                <span
                                                                                    class="badge ${schedule.tourStatus == 'Preparing' ? 'badge-warning' : schedule.tourStatus == 'Scheduled' ? 'badge-primary' : 'badge-secondary'}">
                                                                                    ${schedule.tourStatus}
                                                                                </span>
                                                                            </td>
                                                                    ...
                                                                    <c:forEach var="assignment" items="${assignments}">
                                                                        <tr>
                                                                            <td>
                                                                                <div
                                                                                    style="font-weight:600;color:var(--gray-900);">
                                                                                    ${assignment.schedule.tour.tourName}
                                                                                </div>
                                                                                <div
                                                                                    style="font-size:12px;color:var(--gray-500);">
                                                                                    <fmt:formatDate
                                                                                        value="${assignment.schedule.departureDate}"
                                                                                        pattern="dd/MM/yyyy" />
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div
                                                                                    ...
                                                                                    <div class="guide-avatar"
                                                                                        ...
                                                                                        ${fn:substring(assignment.guide.fullName,
                                                                                        0, 1)}
                                                                                    </div>
                                                                                    <div>
                                                                                        <div
                                                                                            style="font-weight:600;font-size:14px;">
                                                                                            ${assignment.guide.fullName}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                        ...
                        <div class="modal-overlay" id="assignModal">
                            <div class="modal-box">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div
                                        style="background:var(--gray-50);padding:12px 16px;border-radius:10px;margin-bottom:20px;">
                                        <div style="font-weight:600;color:var(--gray-900);" id="modal-tour-name"></div>
                                        <div style="font-size:13px;color:var(--gray-500);" id="modal-departure-date">
                                        </div>
                                    </div>
