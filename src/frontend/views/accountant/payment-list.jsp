<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8" language="java" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        <%@ taglib uri="jakarta.tags.fmt" prefix="fmt" %>
            <%-- Người làm: Dương Ngày tạo file: 2026-07-21 Ý nghĩa: Giao diện theo dõi danh sách thanh toán (Payment).
                                ...
                                <%@ include file="/admin/admin-header-right.jsp" %>
                                    ...
                                    <div class="content-area">
                                        ...
                                        <%-- Stats --%>
                                            ...
                                            <%-- Filter --%>
                                                <form method="get"
                                                    action="${pageContext.request.contextPath}/accountant/payments"
                                                    id="filterForm">
                                                                        ...
                                                                        <tbody>
                                                                            <c:forEach var="p" items="${payments}">
                                                                                <tr>
                                                                                    <td>
                                                                                        <span
                                                                                            class="trans-code">${p.transactionRef}</span>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div>
                                                                                            <a href="${pageContext.request.contextPath}/admin/bookingDetail?id=${p.bookingId}"
                                                                                                target="_blank"
                                                                                                class="booking-code">
                                                                                                #${p.bookingCode}
                                                                                            </a>
                                                                                    ...
                                                                                    <td>
                                                                                        <span
                                                                                            class="badge badge-method">${p.paymentMethod}</span>
                                                                                    </td>
                                                                                    <td>
                                                                                        <c:if
                                                                                            test="${p.status eq 'Success'}">
                                                                                            <span
