<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8" language="java" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        <%-- Người làm: Dương Ngày tạo file: 2026-07-21 Ý nghĩa: Giao diện tổng quan cho Kế toán (Accountant). Hiển thị
            cảnh báo yêu cầu hoàn tiền đang chờ, thống kê thanh toán và các lối tắt chức năng. --%>
    ...
    && sessionScope.sessionUser.role.roleName ne 'Admin')}">
            ...
            <head>
                ...
                <style>
                    ...
                    /* Page-level fade */
                    .content-area>* {
                        animation: tb-fade-up 0.6s cubic-bezier(0.16, 1, 0.3, 1) both;
                    }
                    ...
                    .welcome-text h2 {
                        animation: tb-fade-left 0.6s 0.1s cubic-bezier(0.16, 1, 0.3, 1) both;
                    }

                    .welcome-text p {
                        animation: tb-fade-left 0.6s 0.18s cubic-bezier(0.16, 1, 0.3, 1) both;
                    }

                    .welcome-badge {
                        animation: tb-fade-right 0.6s 0.18s cubic-bezier(0.16, 1, 0.3, 1) both;
                    ...
                    /* Stats grid premium */
                    .stats-grid {
                        animation: tb-fade-up 0.6s 0.2s cubic-bezier(0.16, 1, 0.3, 1) both;
                    }
                    ...
                    /* Stagger quick-cards */
                    .quick-actions-grid>* {
                        animation: tb-fade-up 0.5s cubic-bezier(0.16, 1, 0.3, 1) both;
                    }

                    .quick-actions-grid>*:nth-child(1) {
