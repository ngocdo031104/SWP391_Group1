            ...
            <div class="detail-main-left">
                ...
                <div class="tour-reviews-section" id="reviews">
                    ...
                    <div class="add-review-card">
                        ...
                        <form class="add-review-form" id="new-review-form">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rev-name" placeholder="Ví dụ: Nguyễn Văn A" required>
                                </div>
                                <div class="form-group">
                                    <label for="rev-email">Email (Sẽ được ẩn) *</label>
                                    <input type="email" id="rev-email" placeholder="example@mail.com" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="rev-text">Bình luận chi tiết *</label>
                                <textarea id="rev-text" rows="4" placeholder="Chia sẻ về lịch trình, dịch vụ ăn uống, hướng dẫn viên và phương tiện di chuyển..." required></textarea>
                            </div>
...
<script>
    ...
    <% 
        if (activeTour != null && activeTour.getItinerary() != null && !activeTour.getItinerary().trim().isEmpty()) {
            String itin = activeTour.getItinerary().trim();
            if (itin.startsWith("[")) {
    %>
    itinerariesData[<%= activeTour.getTourId() %>] = <%= itin %>;
    <% 
            } else {
                String[] lines = itin.split("\n");
    %>
    itinerariesData[<%= activeTour.getTourId() %>] = [
        <% 
            int dayCount = 1;
