    ...
    if (newReviewForm) {
        newReviewForm.addEventListener('submit', (e) => {
            ...
            const newReviewObj = {
                ...
                text: text,
                isVerified: true,
                avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=80&q=80", // Sarah avatar default
                image: simulatedUploadedImgUrl
            };

            // Add to start of array
            activeReviews.unshift(newReviewObj);
            renderReviews();

            // Reset form
            newReviewForm.reset();
            if (uploadPreviewRow) uploadPreviewRow.innerHTML = '';
            simulatedUploadedImgUrl = '';
            ...
            alert("Cảm ơn bạn đã gửi đánh giá! Bình luận của bạn đã được duyệt hiển thị ngay lập tức.");
        });
    }
