...
<head>
    ...
    <title>Nh?t Ký Phân Công HDV — TourBuddy Enterprise</title>
    <!-- Fonts -->
...
<div class="dashboard-wrapper">
    ...
    <main class="main-content">
        ...
        <header class="top-header">
            <div>
                <h1>Nh?t Ký Phân Công HDV</h1>
                <p style="color: #9fa9cb; font-size: 0.9rem; margin-top: 4px;">Xem l?ch s? và ch? d?n di?u ph?i hu?ng d?n viên cho các l?ch kh?i hành</p>
            </div>
        ...
        <div class="filter-section">
            <div class="search-container">
                ...
                <input type="text" id="search-input" class="search-input" value="${search}" placeholder="Tìm theo tên tour ho?c hu?ng d?n viên...">
            </div>
            <div style="color: #9fa9cb; font-size: 0.85rem; font-weight: 500;">
                T?ng s? b?n ghi: <span style="font-weight: 700; color: #f8fafc;">${totalCount}</span>
            </div>
        </div>
                ...
                <table class="booking-table" style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            <th>Tên Tour</th>
                            <th style="width: 130px;">Ngày Kh?i Hành</th>
                            <th>Hu?ng D?n Viên</th>
                            <th>Ngu?i Phân Công</th>
                            <th>Ch? d?n / Ghi chú</th>
                            <th style="width: 150px;">Th?i Gian Phân Công</th>
                            <th style="width: 140px; text-align: center;">Hành d?ng</th>
                        </tr>
                    </thead>
                            ...
                            <c:when test="${not empty assignments}">
                                <c:forEach var="a" items="${assignments}">
                                    <tr data-tour="<c:out value='${a.schedule.tour.tourName}'/>" data-guide="<c:out value='${a.guide.fullName}'/>">
                                        ...
                                        <td><c:out value="${not empty a.assignedByName ? a.assignedByName : 'H? th?ng'}"/></td>
                                        <td>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btn-unassign-guide"
                                                ...
                                                <i class="fa-solid fa-user-xmark"></i> H?y phân công
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            ...
                            <c:otherwise>
                                <tr>
                                    <td colspan="8" class="empty-state">
                                        ...
                                        Chua có l?ch s? phân công hu?ng d?n viên nào.
                                    </td>
                                </tr>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <div class="pagination-buttons">
                        <a href="?page=${currentPage - 1}&size=${pageSize}&search=${search}"
                           class="page-link ${currentPage == 1 ? 'disabled' : ''}">
                            <i class="fa-solid fa-angle-left"></i> Tru?c
                        </a>
