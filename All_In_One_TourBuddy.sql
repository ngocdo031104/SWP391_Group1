...
DECLARE @UserID1 INT = (SELECT UserID FROM [User] WHERE Email = 'guide1@tourbuddy.com');

IF NOT EXISTS (SELECT 1 FROM UserProfile WHERE UserID = @UserID1)
BEGIN
    INSERT INTO UserProfile (UserID, AvatarURL, Biography, DateOfBirth, Gender, Address, TravelInterests, UpdatedAt)
...
IF NOT EXISTS (SELECT 1 FROM GuideProfile WHERE UserID = @UserID1)
BEGIN
    INSERT INTO GuideProfile (UserID, YearsOfExperience, TotalToursLed, Rating, Bio, Specialization, Languages, Certifications, EmergencyPhone, IsActive, CreatedAt, UpdatedAt)
...
DECLARE @UserID2 INT = (SELECT UserID FROM [User] WHERE Email = 'guide2@tourbuddy.com');

IF NOT EXISTS (SELECT 1 FROM UserProfile WHERE UserID = @UserID2)
BEGIN
    INSERT INTO UserProfile (UserID, AvatarURL, Biography, DateOfBirth, Gender, Address, TravelInterests, UpdatedAt)
...
IF NOT EXISTS (SELECT 1 FROM GuideProfile WHERE UserID = @UserID2)
BEGIN
    INSERT INTO GuideProfile (UserID, YearsOfExperience, TotalToursLed, Rating, Bio, Specialization, Languages, Certifications, EmergencyPhone, IsActive, CreatedAt, UpdatedAt)
...
DECLARE @UserID3 INT = (SELECT UserID FROM [User] WHERE Email = 'guide3@tourbuddy.com');

IF NOT EXISTS (SELECT 1 FROM UserProfile WHERE UserID = @UserID3)
BEGIN
    INSERT INTO UserProfile (UserID, AvatarURL, Biography, DateOfBirth, Gender, Address, TravelInterests, UpdatedAt)
...
IF NOT EXISTS (SELECT 1 FROM GuideProfile WHERE UserID = @UserID3)
BEGIN
    INSERT INTO GuideProfile (UserID, YearsOfExperience, TotalToursLed, Rating, Bio, Specialization, Languages, Certifications, EmergencyPhone, IsActive, CreatedAt, UpdatedAt)
